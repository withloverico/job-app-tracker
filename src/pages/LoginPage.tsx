      ...
      <div className="min-h-dvh flex flex-col items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-sm text-center frost-strong rounded-2xl p-8 shadow-lg pop-up">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white/80 hover:bg-white text-stone-800 font-medium py-3 px-4 rounded-xl transition-all duration-300 shadow-sm border border-stone-200/50 pulse-glow hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(180,83,9,0.3)]"
          >
      ...
      <main className="px-4 pb-20">
        ...
        >
          <div className={`frost-strong rounded-2xl p-8 sm:p-12 shadow-lg ${popClass('cta')}`} style={{ animationDelay: '0.15s' }}>
            ...
            <button
              onClick={signInWithGoogle}
              className="inline-flex items-center gap-3 bg-amber-700 hover:bg-amber-600 text-white font-medium py-3 px-8 rounded-xl transition-all duration-300 shadow-sm text-base hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(180,83,9,0.35)]"
            >
              get started free
