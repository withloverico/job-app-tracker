  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <select
        ...
        className="w-full appearance-none frost-input text-stone-800 rounded-lg pl-7 pr-8 py-2 text-sm focus:outline-none cursor-pointer"
      >
        {STATUSES.map((s) => (
      ...
      <div className="pointer-events-none absolute right-2 top-1/2 -translate-y-1/2 text-stone-400">
